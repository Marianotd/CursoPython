# Funciones lambda
# Son funciones anónimas, y son pequeñas (una linea de código)
...
# No se necesita agregar paréntisis para los parámetros
# No se necesita usar la palabra return, pero si debe regresar una expresión válida
...
print(f'Resultado función lambda: {mi_funcion_lambda(1, 2, 4, 5, 6, 7, d=8, e=9)}')
